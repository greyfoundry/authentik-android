 ...
 * @param credentials
 * @param chromeUrl Full URL to be used in Google Workspace configuration
 * @param connectorUuid
 * @param enabled
 */
@Serializable

data class GoogleChromeConnector (
    ...
    @SerialName(value = "chrome_url")
    val chromeUrl: kotlin.String?,
