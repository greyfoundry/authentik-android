 ...
 */
@Serializable
enum class CountryCodeEnum(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is CountryCodeEnum) "$data" else null

        /**
         * Returns a valid [CountryCodeEnum] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): CountryCodeEnum? = data?.let {
